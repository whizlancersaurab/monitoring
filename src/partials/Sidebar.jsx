      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/" className="block">
            <div className="font-bold text-2xl">TERASTAMP</div>
          </NavLink>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("calendar") && "from-violet-500/12 dark:from-violet-500/24 to-violet-500/4"}`}>
                <NavLink
                  end
                  to="/"
              ...
              {/* Messages */}
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("messages") && "from-violet-500/12 dark:from-violet-500/24 to-violet-500/4"}`}>
                <NavLink
                  end
                  to="#"
              ...
              {/* Inbox */}
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("inbox") && "from-violet-500/12 dark:from-violet-500/24 to-violet-500/4"}`}>
                <NavLink
                  end
                  to="#"
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sensors</span>
                  </div>
                </NavLink>
              </li>
              {/* Calendar */}
              ...
              {/* Campaigns */}
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r ${pathname.includes("campaigns") && "from-violet-500/12 dark:from-violet-500/24 to-violet-500/4"}`}>
                <NavLink
                  end
                  to="/"
