...
const NotFoundPage = () => {
    return (
        <main className="grid min-h-full place-items-center bg-gray-50 dark:bg-gray-700 px-6 py-24 sm:py-32 lg:px-8 transition-colors duration-300">
            <div className="text-center">
                <p className="text-base font-semibold text-indigo-500 dark:text-indigo-400">404</p>
